      ...
      <div class="container py-xl-5 py-lg-3">
        <div class="row">
          <div class="col-md-4 w3l-footer">
            ...
            <p>Saving lives through community-driven blood donations, 
              bringing together individuals to make a meaningful impact on the health and well-being of those in need.
               Every donation counts, and together, 
               we can ensure a constant and reliable supply of life-saving blood for patients in emergencies and critical care.
            </p>
          </div>
...
{ ?>
        ...
        <div class="border-top mt-5 pt-lg-4 pt-3 pb-lg-0 pb-3 text-center">
          <p class="copy-right-grids mt-lg-1">© 2025 Blood Bank Donor Management System. All rights reserved.
